...
| desired\_capacity | The number of Amazon EC2 instances that should be running in the group | string | - | yes |
...
| health\_check\_type | Controls how health checking is done. Values are - EC2 and ELB | string | - | yes |
