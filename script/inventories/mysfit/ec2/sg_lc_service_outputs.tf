...
output "sg_lc_ecs_cluster_debug_ingresses" {
  value = aws_security_group.lc_ecs_cluster_debug[*].ingress
}
output "sg_lc_ecs_cluster_debug_egresses" {
  value = aws_security_group.lc_ecs_cluster_debug[*].egress
}
