...
# Lambda function
#--------------------------------------------------------------------------------
variable "lambda_process_question_handler_method" {
  description = "Handler name of the lamda function so as to invoke the lambda as 'lamda_file_name.handler_name'"
  type = string
}
variable "lambda_process_question_function_name" {
  description = "Lambda function name"
  type = string
}
variable "lambda_process_question_alias_name" {
...
#--------------------------------------------------------------------------------
variable "lambda_process_question_runtime" {
  description = "Runtime for the rambda"
  default = "python3.6"
}
variable "lambda_process_question_memory_size" {
  default = "128"
}
variable "lambda_process_question_timeout" {
  default = "300"
}