...
# Importing the remote state resource references, etc.
#----------------------------------------------------------------------
locals {
  #----------------------------------------------------------------------
...
#----------------------------------------------------------------------
# Forward clicks API to the firehose
#----------------------------------------------------------------------
locals {
  # Bucket to upload lambda package
  bucket_name                            = data.terraform_remote_state.s3.outputs.bucket_data
  sagemaker_recommendation_endpoint_name = data.terraform_remote_state.sagemaker.outputs.sagemaker_recommendation_endpoint_name
